            ...
            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                <tr>
                    <td align="center" height="70" style="height:70px;">
                        <a href="{{route('Homepage')}}" style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; width: 100px;" src="{{ asset("storage")."/".setting('site.logo') }}" alt="" /></a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="center"
                        ...
                        <div style="line-height: 35px">
                            ...
                            {!!  statictext('email','news.title',$lang) !!}
                            ...
                            <tr>
                                <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                    <div style="line-height: 26px;">
                                        <a href="{{route('Blog')}}" style="color: #ffffff; text-decoration: none;">{{statictext('email','news.visit',$lang)}}</a>
                                    </div>
                                </td>
                            </tr>
...
@foreach(lastNews(4, $lang) as $post)
    <!--  50% image -->
                    ...
                    <tr>
                        <td>
                            <table border="0" align="left" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td align="center">
                                        <a href="{{route('Post',$post->slug)}}" style=" border-style: none !important; border: 0 !important;"><img
                                ...
                                <tr>
                                    <td align="left">
                                        <table border="0" align="left" cellpadding="0" cellspacing="0" class="container590">
                                            <tr>
                                                <td align="center">
                                                    <table align="center" width="40" border="0" cellpadding="0"
                                ...
                                <tr>
                                    <td align="left">
                                        <table border="0" align="left" cellpadding="0" cellspacing="0" class="container590">
                                            <tr>
                                                <td align="center">
                                                    <table border="0" align="center" width="120" cellpadding="0"
                                                           cellspacing="0" style="border: 1px solid #eeeeee; ">
                                                            ...
                                                            <td align="center"
                                                                ...
                                                                <div style="line-height: 20px;">
                                                                    <a href="{{route('Post',$post->slug)}}"
                                                                       style="color: #5caad2; text-decoration: none;">READ
                                                                        MORE</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td height="8" style="font-size: 8px; line-height: 8px;">
                                                                &nbsp;
                                                            </td>
                                                        </tr>
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                        ...
                                        Email us: <br/> <a href="mailto:{{setting('site.email')}}"
                                                           style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">{{setting('site.email')}}</a>
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <div style="line-height: 24px;">
                                        ...
                                        <span style="color: #333333;">{{setting('site.title')}}</span>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <a style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;color: #5caad2; text-decoration: none;font-weight:bold;"
                                                   href="{{route('Unsubscribe',$token)}}">{{statictext('email','unsubscribe', $lang)}}</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
