...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            <a href="{{ route('groups.trainings.create', Request::route('group')) }}" class="btn btn-success btn-add-new">
        ...
        @can('edit', app($dataType->model_name))
            @if(!empty($dataType->order_column) && !empty($dataType->order_display_column))
                <a href="{{ route('groups.trainings.order', request()->route('group')) }}" class="btn btn-primary btn-add-new">
